...
def connect_to_server(server_name):
    ...
    # Un socket es una abstracción de comunicación que permite que 
    # diferentes procesos en una red intercambien datos. Básicamente, 
    # un socket es un punto final de una conexión bidireccional entre 
    # dos programas en una red. Permite que estos programas se 
    # comuniquen entre sí, ya sea en la misma máquina o en máquinas 
    # diferentes a través de una red.
